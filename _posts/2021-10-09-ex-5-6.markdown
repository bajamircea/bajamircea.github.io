---
layout: post
title: "Exercise 5 and 6"
categories: maths logic
---

Exercise 5 and 6 from Kleene's IM (1952) page 149
...
The superscript can be discharged if despite the application of Rule 9 or 12
with respect to $$x$$ in circumstances like:
- the assumption does not contain $$x$$ free
- we end up with no assumption
For reference, Kleene uses the superscript discharge in IM on the same page
149, in the two circumstances above for Example 2 at step 2 and Example 3 at
step 3.

Note that the generality elimination has no restrictions: no superscript and it
has not subsidiary deduction.
